...
Rails.application.config.assets.precompile += %w(login/connexion.css login/inscription.css)
Rails.application.config.assets.precompile += %w(application/booker.css application/owner.css)
Rails.application.config.assets.precompile += %w(style_guide/style_guide.css)
